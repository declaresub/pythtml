...
class _Element(_BaseElement):
    ...
    def generate_html(self, name, is_empty, children, attributes):
        if is_empty:
...
for element_name, is_empty in ELEMENTS:
    setattr(sys.modules[__name__], element_name, partial(_Element, element_name, is_empty))
